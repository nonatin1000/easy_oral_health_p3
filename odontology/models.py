...
class Address(AuditModel):
	...
	complement = models.CharField(u'Complemento', max_length=255)
	zip_code = models.CharField(u'CEP', max_length=10)
	reference_point = models.CharField(u'Ponto de Referência', max_length=255)
	neighborhood = models.CharField(u'Bairro', max_length=255)
	country = models.CharField(u'País', max_length=255)
