...
urlpatterns = [
    ...
    url(r'^oral_patient_procedure_register/$', views.oral_patient_procedure_register , name='oral_patient_procedure_register'),
    ...
    url(r'^oral_patient_procedure_show/(?P<oral_patient_procedure_id>\d+)/$', views.oral_patient_procedure_show , name='oral_patient_procedure_show'),
